...
public class BankAccountController {
    ...
    @Operation(summary = "Update bank account by ID", responses = {
            @ApiResponse(responseCode = "201", description = "Bank account updated successfully"),
            @ApiResponse(responseCode = "404", description = "Bank account not found"),
            @ApiResponse(responseCode = "500", description = "Internal server error")
    })
    ...
    @Operation(summary = "Delete bank account by ID", responses = {
            @ApiResponse(responseCode = "202", description = "Bank account deleted successfully"),
            @ApiResponse(responseCode = "404", description = "Bank account not found"),
            @ApiResponse(responseCode = "500", description = "Internal server error")
    })
